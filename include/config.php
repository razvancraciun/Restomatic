...
define('APP_ROUTE', '/restomatic/');
define('IMG_ROUTE', APP_ROUTE.'img/');
define('CSS_ROUTE', APP_ROUTE.'css/');
define('JS_ROUTE', APP_ROUTE.'js/');
...
/* */
$app = Restomatic\Application::getSingleton();
$app->init(array('host'=>BD_HOST, 'bd'=>BD_NAME, 'user'=>BD_USER, 'pass'=>BD_PASS), APP_ROUTE, APP_ROOT);